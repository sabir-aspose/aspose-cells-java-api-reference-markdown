...
source_url: "https://reference.aspose.com/cells/java/com.aspose.gridweb/worksheetdesign/"
generated_from: "online-reference"
fetched_at: "2026-06-16T11:59:09+00:00"
---
**Inheritance:**
...
| [setEditableRange(int startRow, int startColumn, int rows, int columns)](#setEditableRange-int-int-int-int-) | Makes a range of cells editable. [http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells](http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells) Make all cells read only by calling the SetAllCellsReadonly method. |
...
| [setReadonlyRange(int startRow, int startColumn, int rows, int columns)](#setReadonlyRange-int-int-int-int-) | Makes a range of cells readonly. [http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells](http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells) First make all cells editable by calling the SetAllCellsEditable method. |
...
Makes a range of cells editable. [http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells](http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells) Make all cells read only by calling the SetAllCellsReadonly method. then call this method to Specify the range of cells that to be editable
...
Makes a range of cells readonly. [http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells](http://docs.aspose.com:8082/docs/display/cellsnet/Protecting+Cells) First make all cells editable by calling the SetAllCellsEditable method. then call this method to Specify the range of cells that to be readonly
