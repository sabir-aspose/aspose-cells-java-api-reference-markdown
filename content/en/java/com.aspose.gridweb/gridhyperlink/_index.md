...
type: docs
url: "/java/com.aspose.gridweb/gridhyperlink/"
source_url: "https://reference.aspose.com/cells/java/com.aspose.gridweb/gridhyperlink/"
generated_from: "online-reference"
fetched_at: "2026-06-16T11:58:23+00:00"
---
**Inheritance:**
java.lang.Object
...
| [getImageURL()](#getImageURL--) | Gets Image URL for the link, there is no imageurl properties in hyperlink, so actually use TextToDisplay to record this value ,TextToDisplay will be set to ![](value) so it will change the value of TextToDisplay |
...
| [setImageURL(String value)](#setImageURL-java.lang.String-) | Sets Image URL for the link, there is no imageurl properties in hyperlink, so actually use TextToDisplay to record this value ,TextToDisplay will be set to ![](value) so it will change the value of TextToDisplay |
...
Gets Image URL for the link, there is no imageurl properties in hyperlink, so actually use TextToDisplay to record this value ,TextToDisplay will be set to ![](value) so it will change the value of TextToDisplay
...
Sets Image URL for the link, there is no imageurl properties in hyperlink, so actually use TextToDisplay to record this value ,TextToDisplay will be set to ![](value) so it will change the value of TextToDisplay
