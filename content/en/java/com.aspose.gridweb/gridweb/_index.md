...
description: "The basic class of GridWeb control."
type: docs
url: "/java/com.aspose.gridweb/gridweb/"
source_url: "https://reference.aspose.com/cells/java/com.aspose.gridweb/gridweb/"
generated_from: "online-reference"
fetched_at: "2026-06-16T11:58:41+00:00"
---
**Inheritance:**
...
Gets the web path of the script/image files of the control. For example: “http://localhost/acw_client”. You may also set this value in the web.config file. Add this section to the `<configuration>` section:
`<appSettings>`
...
Gets the web url of the language file of the control. For example: “/acw_client/lang_en.js”.
...
Sets the web path of the script/image files of the control. For example: “http://localhost/acw_client”. You may also set this value in the web.config file. Add this section to the `<configuration>` section:
`<appSettings>`
`<add key="aspose.cells.gridweb.acw_client_path" value="/acw_client/" />`
`</appSettings>`
...
Sets the web url of the language file of the control. For example: “/acw_client/lang_en.js”.
By default, a built-in english file is used.
